...
Für alle Projekte gilt natürlich, dass Sie zuerst die allgemeine Aufgabenstellung und den Code (falls vorhanden) verstehen sollten, bevor Sie die untenstehen Aufgaben bearbeiten.
...
\begin{itemize}
    ...
    \item (Sehr schwierig!) Implementieren Sie eine Suche, welche das Aufheben mehrerer Karten in betracht zieht.
\end{itemize}
